...
const DICT: Record<string, TranslationEntry> = {
  ...
  'fp.prixObligatoire': { fr: 'Le prix est obligatoire', en: 'Price is required' },
  'fp.prixMinimum': { fr: 'Le prix doit être supérieur à 0', en: 'Price must be greater than 0' },
  'fp.prixMaximum': { fr: 'Le prix ne peut pas dépasser 99 999 TND', en: 'Price cannot exceed 99,999 TND' },
  'fp.quantiteObligatoire': { fr: 'La quantité est obligatoire', en: 'Quantity is required' },
  'fp.quantiteMaximum': { fr: 'La quantité ne peut pas dépasser 99 999', en: 'Quantity cannot exceed 99,999' },
  'fp.numeroLotMin': { fr: 'Numéro de lot trop court (min. 2 caractères)', en: 'Lot number too short (min. 2 characters)' },
  'fp.numeroLotFormat': { fr: 'Format invalide — lettres, chiffres, tirets uniquement', en: 'Invalid format — letters, digits, hyphens only' },
  'fc.nomPattern': { fr: 'Le nom contient des caractères non autorisés', en: 'Name contains invalid characters' },
  ...
  'checkout.nomTropCourt': { fr: 'Le nom doit contenir au moins 2 caractères', en: 'Name must be at least 2 characters' },
  'checkout.nomInvalide': { fr: 'Le nom ne doit contenir que des lettres', en: 'Name must contain letters only' },
  'checkout.emailObligatoire': { fr: 'L\'email est obligatoire pour la confirmation', en: 'Email is required for order confirmation' },
  'checkout.emailInvalideFormat': { fr: 'Format email invalide (ex: nom@domaine.com)', en: 'Invalid email format (e.g.: name@domain.com)' },
  'checkout.telephoneObligatoire': { fr: 'Le numéro de téléphone est obligatoire', en: 'Phone number is required' },
  'checkout.telephoneFormat': { fr: 'Numéro TN invalide — doit commencer par 2, 3, 4, 5, 7 ou 9', en: 'Invalid TN number — must start with 2, 3, 4, 5, 7 or 9' },
  'checkout.telephoneLongueur': { fr: 'Le numéro doit contenir exactement 8 chiffres', en: 'Number must be exactly 8 digits' },
  'checkout.placeholderTel': { fr: '8 chiffres (ex: 22 345 678)', en: '8 digits (e.g.: 22 345 678)' },
  'checkout.adresseObligatoire': { fr: 'L\'adresse de livraison est obligatoire', en: 'Delivery address is required' },
  'checkout.adresseTropCourte': { fr: 'Adresse trop courte — précisez la rue, ville et code postal', en: 'Address too short — include street, city and postal code' },
  'checkout.caracteres': { fr: 'caractères', en: 'characters' },
